<template>
  <div class="login" v-if="!loading">
    ...
    <div class="btn-area flex column q-mt-lg">
      <q-btn square unelevated color="dark" class="q-pl-xs items-start google" @click="googleLogin">
        <img :src="googloLogo" alt="googloLogo" class="q-pr-xl"/>
        <span class="q-pr-xl">구글로 로그인</span>
      </q-btn>

      <q-btn square unelevated color="indigo" class="q-pl-xs q-mt-sm items-start kakao">
        <img :src="kakaoLogo" alt="kakaoLogo" class="q-pr-xl"/>
        <span class="q-pr-xl">카카오로 로그인</span>
      </q-btn>

      <q-btn square unelevated color="indigo" class="q-pl-xs q-mt-sm items-start naver">
